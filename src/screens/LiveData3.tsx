...
const LiveData: React.FC = observer(({
  ...
  return(
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{flexDirection:'row', marginTop:ms(50,0.5)}}>
      <ButtonTitle textStyle={{color: (isSensor1On ? colors.main : colors.lightGrey), marginLeft: ms(20,0.5)}} title={t.do('sensor1')} onPress={()=>{
          toggleSensor1();
      }}/>
      <ButtonTitle textStyle={{color: (isSensor2On ? colors.main : colors.lightGrey)}} title={t.do('sensor2')} onPress={()=>{
          toggleSensor2();
      }}/>
      <ButtonTitle textStyle={{color:colors.main, marginLeft: ms(100,0.5)}} title={t.do('dismiss')} onPress={()=>{
