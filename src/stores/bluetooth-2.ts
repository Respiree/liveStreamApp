    ...
    if(data.value[0] == BleSensorConstant.BLE_SENSOR_COMMAND_START_BYTE
      ...
      //} else {
          ...
          do {
              ...
              if(mBleSensorPackedFormat) {
                  /*if(this.liveMode) {
                      sensor1 = (value[start + 10] << 8) | (value[start + 9]);
                      sensor2 = (value[start + 12] << 8) | (value[start + 11]);
                      axl_x = (value[start + 14] << 8) | (value[start + 13]);
                      axl_y = (value[start + 16] << 8) | (value[start + 15]);
                      axl_z = (value[start + 18] << 8) | (value[start + 17]);
                  } else {
                      sensor1 = (value[start + 9] << 8) | (value[start + 10]);
                      sensor2 = (value[start + 11] << 8) | (value[start + 12]);
                      axl_x = (value[start + 13] << 8) | (value[start + 14]);
                      axl_y = (value[start + 15] << 8) | (value[start + 16]);
                      axl_z = (value[start + 17] << 8) | (value[start + 18]);
                  }*/
                  /*if(this.liveMode) {
                      sensor1 = (value[start + 13] << 8) | (value[start + 12]);
                      sensor2 = (value[start + 15] << 8) | (value[start + 14]);
                      axl_x = (value[start + 17] << 8) | (value[start + 16]);
                      axl_y = (value[start + 19] << 8) | (value[start + 18]);
                      axl_z = (value[start + 21] << 8) | (value[start + 20]);
                  } else*/ {
              ...
              if(sensor1 == 0 && sensor2 == 0 && axl_x == 0 && axl_y == 0 && axl_z == 0) {
                  ...
                  if(this.liveMode) {
                      this.callbackToAllListener(null, {type:SuccessType.Ble_Single_Sensor_Data, sensor1, sensor2 });
                  }
